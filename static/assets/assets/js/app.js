...
(function ($) {
  ...
  if(currentLink[3] != null)
  var Href = "/" + currentLink[3];
  ...
  drake.on("drop", function(el, target, source) {
    if (target.id === "todo" || target.id === "progress") {
      const draggedItemId = el.id;
      var ele = draggedItemId + "-score";
      const element_4 = document.getElementById(ele);
      element_4.style.display = 'none';

      ele = draggedItemId + "-dayleft";
      const element_5 = document.getElementById(ele);
      element_5.style.display = 'block';  

      ele = draggedItemId + "-done";
      const element_6 = document.getElementById(ele);
      ...
      const draggedItemId = el.id;
      var ele = draggedItemId + "-score";
      const element_1 = document.getElementById(ele);
      element_1.style.display = 'block';  
      
      ele = draggedItemId + "-dayleft";
      const element_2 = document.getElementById(ele);
      element_2.style.display = 'none';  

      ele = draggedItemId + "-done";
      const element_3 = document.getElementById(ele);
